...
const members = [
  ...
  { name: "Dillon Willis", role: "Maintenance & Special Projects Coordinator, Realtor®", image: "/team/dillon-willis.jpg" },
  { name: "Abigail Willis", role: "HOA Manager, Realtor®", image: "/team/abigail-willis.jpg" },
